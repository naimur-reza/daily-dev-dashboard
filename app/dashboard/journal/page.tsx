    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {(!entries || entries.length === 0) ? (
        <div className="text-center py-16 text-gray-600">
          ...
          <p className="text-sm">Fill in your daily standup journal on the dashboard.</p>
        </div>
      ) : (
        <div className="space-y-4">
          {entries.map((entry) => (
            <div key={entry.id} className="bg-gray-900 border border-gray-800/60 rounded-xl p-5">
                ...
                {[
                  ...
                  <div key={label}>
                    ...
                    <p className="text-sm text-gray-300 leading-relaxed">
                      {value || <span className="text-gray-600 italic">not filled in</span>}
                    </p>
                  </div>
                ))}
              </div>
